...
exports.TIMED_OUT = exports.NOT_FOUND = exports.NOT_AUTHORIZED = exports.CW_RESPONSE_INVALID_TOKEN = exports.CW_RESPONSE_INVALID_CODE = exports.CW_RESPONSE_NO_OFFERS = exports.CW_RESPONSE_WRONG_USER_ID = exports.CW_RESPONSE_BATTLE_IS_NEAR = exports.CW_RESPONSE_USER_BUSY = exports.CW_RESPONSE_NO_FUNDS = undefined;
  ...
  async function processProfileResponse(action, result, payload) {
    ...
    if (result === CW_RESPONSE_OK) {
      if (action === Msg.ACTION_GRANT_TOKEN) {
        try {
          await _db2.default.setToken(userId, payload);
        } catch (err) {
          rejectCached(cached, payload);
        }
      }
